      ...
      <div className="container">
        ...
        <div className="content">
          <div className="text">
            ...
            <br />
            하지만 인간을 단순히 4가지 범주로 진단시, 매우 복잡한 인간 성격과
            행동의 다양성을 모두 포괄하기에는 한계가 있습니다. 세계 인구 81억명
            각자 독특한 지문을 가지고 있듯이, 각 개인 성격도 고유합니다. 이러한
            인식 하에, 저희는 계속해서 더 나은 접근 방법을 모색하고 있습니다.
            <br />
            <br />
            <br />
            ...
            <div className="detail">
              ...
              (사람을 사고/감정, 감각/직관 축으로 구분, DISC, MBTI,Big5등 대다수
              연구는 융을 기본)
            </div>
            <div className="detail">
              <div className="number">②</div> Big Five, MBTI, DISC 그리고
              심리측정학적 원칙을 통합하여 개발되었습니다. 각 이론의 강점과
              약점을 반영하여 성격 특성과 행동 패턴을 더 발전시켰습니다. 4개
              유형과 12개 캐릭터를 추가 제공해서 진단 결과 활용도를 높였습니다.
            </div>
            <div className="detail">
              <div className="number">③</div> 각 문항과 결과는 한국어를 모국어로
              하는 대학교수, 행동/인지심리 전문가와 수차례 반복 점검했으며
              문항간 통계 타당/신뢰도는 충분히 확보했으며 머신러닝 가상데이터를
              확보, 검증 과정 수십만회를 거쳐 완성도를 높였으며 현재도 실제
              데이터로 계속 업데이트 중입니다.
            </div>
            <br />
            <br />
            <div className="text-bottom">
              ...
              내에서의 역동성을 향상에 기여합니다. 더 나아가, REAL Personality는
