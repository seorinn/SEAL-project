      ...
      <div className="container">
        ...
        <div className="content">
          <div className="text">
            ...
            인식할 수 있는 중요한 계기가 <br />
            되었습니다. 국민 진단도구 MBTI, 많이 알려진 DISC, 그리고 성격/행동
            유형 분야에서 구조적으로 강력한 <br />
            BIG 5 검사 등, 인간을 유형화하는 다양한 접근법이 존재합니다. <br />
            <br />
            인간을 단순히 4가지 범주로 진단시, 매우 복잡한 인간 성격과 행동의
            다양성을 모두 포괄하기에는 한계가
            <br /> 있습니다. 세계 인구 81억명이 각자 독특한 지문을 가지고
            있듯이, 각 개인 성격도 고유합니다. 이러한 인식
            <br /> 하에, 저희는 계속해서 더 나은 접근 방법을 모색하고 있습니다.
            <br />
            <br />
            <br />
            ...
            <div className="detail">
              ...
              <br />
              문항간 통계 타당/신뢰도는 충분히 확보하였습니다. 또한 머신 러닝을
              통하여 진단의 완성도를 높이고,
              <br /> 현재도 실제 데이터의 수집 통하여 진단을 계속 업데이트하고
              있습니다.
            </div>
            <br />
            <br />
            <div className="text-bottom">
              ...
              내에서의
              <br /> 역동성 향상에 기여합니다. 더 나아가, REAL Personality는 각
              개인이 <br />
              자신만의 특성을 이해하고, 다른 사람들과의 관계에서도 이해와 공감
              능력을 높일 수 있도록 설계되었습니다.
            </div>
            <br />
            <div className="text-bottom">
