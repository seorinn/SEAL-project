      ...
      <div className="container">
        ...
        <div className="content">
          <div className="text">
            ...
            나누자'는 열정을 가지고 이 모험을 시작했습니다. 이제 그 작은 꿈은
            대한민국을 대표하는 HRD(성인/기업교육) 교육기관으로 성장하며, 지난
            ...
            맞이하여 '우리만의 진단 도구'를 개발하는 데 결정적인 영감을
            제공했습니다.
            <br />
            <br />
            'REAL'시리즈는 루트컨설팅이 실제와 실용에 기반한 데이터와 저희만의
            철학을 검증된 이론 위에 세운 응용 방법론입니다. 지금 보고 게시는
            'REAL Personality'진단은 'REAL' 시리즈의 기반 진단 리포트로, 조직
            진단, DEI(다양성, 평등, 포용), 정서, 지능, 코칭, 리더십 등 다양한
            성과 분야에서 필요한 솔루션과 연계될 수 있습니다.
            <br />
            <br />이 프로그램은 조직 내에서 개인과 팀의 성장을 지원하며, 각
            개인의 잠재력을 최대한 발휘할 수 있도록 돕습니다. 루트컨설팅은 이를
            통해 여러분에게 조용하지만 강력한 지원을 제공하며, 교육의 새로운
            장을 함께 열어갈 준비가 되어 있습니다.
            <br />
            <br />
